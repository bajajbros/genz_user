...
class SearchScreenPickup extends StatefulWidget {
  const SearchScreenPickup({Key? key}) : super(key: key);

  @override
  State<SearchScreenPickup> createState() =>
      _SearchScreenPickupState();
}

class _SearchScreenPickupState extends State<SearchScreenPickup> {
               ...
               const SizedBox(height: 35,),
                Stack(
                  children: [
                    ...
                    Center(
                      child: Text('Search & Set PickUp Location',
          ...
          Expanded(
              ...
              itemBuilder: (context, index){
                ...
                // print(placePredictedList[index].secondaryText);
                  return PlacePredictionTileDesignForPickup(
